...
<div
    ...
    <div className="space-y-2 text-gray-700 dark:text-gray-300">
        ...
        <p>
            ...
            <span className={`ml-2 inline-block px-2 py-1 text-xs font-semibold rounded ${ user.role === 'admin'
                ? 'bg-red-100 text-red-800 dark:bg-red-700 dark:text-red-100' : user.role === 'user'
