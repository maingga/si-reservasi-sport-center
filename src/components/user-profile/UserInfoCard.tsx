  ...
  return (
    <form
      ...
      className="p-6 border border-gray-200 rounded-lg bg-white shadow-sm
                 dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300 space-y-6 max-w-md"
    >
      ...
      <button
        type="submit"
        disabled={loading}
        className={`w-full rounded bg-blue-600 px-4 py-2 text-white font-semibold 
